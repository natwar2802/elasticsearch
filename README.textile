...
We need to have a jdk-8 installed or adoptopenjdk-8 installed using Homebrew. 
set JAVA_HOME everytime we start a new terminal using @export JAVA_HOME=/Library/Java/JavaVirtualMachines/adoptopenjdk-8.jdk/Contents/Home@ 
