...
installation can be done by just cloning this repository ,switching to 5.4 branch by writing git checkout 5.4 in the terminal, after that we can run ./gradlew assemble for assembling distributions then we can import the project as a gradle project using intellij idea.
